...
//TO DO
//hacer que se actualicen las coordenadas del texto mientras se arrastra
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function createDraggable(text) {
    ...
    xInput.on("input", function() {
      ...
      if (index !== -1) {
        createdTextElements[index].textElement.attr("x", newX);
      }
    });
    ...
    yInput.on("input", function() {
      ...
      if (index !== -1) {
        createdTextElements[index].textElement.attr("y", newY);
      }
    });
